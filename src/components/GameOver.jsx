...
export default function GameOver({
  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col items-center justify-center text-center z-10 animate-casual-in py-4 sm:py-8">
      {/* Insignia Trofeo / Check */}
      <div className="w-24 h-24 rounded-3xl bg-gradient-to-tr from-red-600 to-red-500 p-1 mb-5 shadow-2xl flex items-center justify-center">
        <div className="w-full h-full rounded-2xl bg-white flex items-center justify-center">
          <FileCheck size={46} className="text-red-600" />
        </div>
      </div>
      ...
      {/* Tarjeta de Resumen Casual Gaming (Sin revelar respuestas correctas) */}
      <div className="casual-card text-left shadow-2xl">
        <div className="flex items-center justify-between pb-4 mb-5 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            <ShieldCheck size={22} className="text-red-600" />
            <span className="font-bold text-slate-800 text-lg">Respuestas Registradas</span>
          </div>
        ...
        {/* Nota informativa sobre resultados futuros */}
        <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200/60 text-xs sm:text-sm text-amber-900 mb-4 flex items-start gap-3 leading-relaxed">
