        ...
        <div id="card-instrucciones" className="instructions-container">
          <div className="instruction-row">
            <div className="instruction-icon-box text-amber-500 shrink-0">
              <Zap size={26} className="stroke-[2.5]" />
            </div>
          ...
          <div className="instruction-row">
            ...
            <span className="text-lg text-slate-900 font-medium">
              Al presionar <strong className="text-slate-950 font-bold">Comenzar</strong> se iniciará el cronómetro.
            </span>
          </div>
          ...
          <div className="instruction-row">
            ...
            <span className="text-lg text-slate-900 font-medium">
              <strong className="text-slate-950 font-bold">Uso único:</strong> Cada trivia permite un solo intento por participante.
            </span>
          </div>
        </div>
      </div>
